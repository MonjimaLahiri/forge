      ...
      <div className="flex-1 px-4 py-3 flex flex-col gap-3">
        ...
        >
          {loading ? (
            ...
            <>
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#3a6cf4" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
function ChatPreview({ widget }: SharedProps) {
  ...
  function handleSend() {
    ...
    setTimeout(() => {
      setMessages(prev => [
        ...prev,
        { role: 'ai', text: 'This is a mock response. Connect a real AI model for actual conversation.' },
      ]);
      setThinking(false);
    }, 800);
  }
